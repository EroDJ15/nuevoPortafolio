...
const About = () => {
  return (
    ...
    >
      <div>
        <h2 className="text-[35px] px-3 text-white font-semibold mb-6 leading-normal pt-4 text-center justify-items-center flex-auto lg:items-center items-center flex-col">
      ...
      <div className="h-min flex-grow lg:items-center items text-white lg:py-0 text-center gap-6 lg-tex-center flex lg:flex-row flex-co-reverse justify-left lg:gap-28 items-center">
        ...
        <h2 className="text-lg font-serif mb-20 leading-normal lg:py-0 flex-col lg:items-start text-white lg:px-2 px-6 py-6 text-left gap-5 lg-tex-center flex lg:flex-row flex-co-reverse justify-between lg:gap-28 items-center">
          {" "}
